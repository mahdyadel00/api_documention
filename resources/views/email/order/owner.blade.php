                     ...
                     <tr style="border-collapse:collapse;"> 
                      <td align="right" style="padding:0;Margin:0;padding-top:10px;"> 
                       <table border="0" cellspacing="1" cellpadding="1" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;width:500px;" class="cke_show_border" role="presentation"> 
                         ...
                         <tr style="border-collapse:collapse;"> 
                          <td style="padding:0;Margin:0;"><h4 style="Margin:0;line-height:200%;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;color:#333333;">Application Commission:</h4></td> 
                          <td style="padding:0;Margin:0;color:#FF0000;"><strong>{{ $order->application_amount }} SAR</strong></td> 
                         </tr>
                        ...
                        <tr style="border-collapse:collapse;"> 
                         ...
                         {{-- <tr style="border-collapse:collapse;"> 
                          <td style="padding:0;Margin:0;color:#659C35;font-size: 20px;"><strong> SAR {{ $order->owner_total }}  </strong></td> 
                        ...
                        <tr style="border-collapse:collapse;"> 
                          <td style="padding:0;Margin:0;color:#659C35;"><strong> SAR {{ $order->service_fees }} </strong></td> 
                      ...
                      <tr style="border-collapse:collapse;"> 
                          <td style="padding:0;Margin:0;color:#659C35;"><strong> SAR {{ $order->tax_amount }} </strong></td> 
                         ...
                         <tr style="border-collapse:collapse;"> 
                          <td style="padding:0;Margin:0;color:#FF0000;font-size: 20px;"><strong> SAR {{ $order->application_amount +  $order->tax_amount + $order->service_fees }}  </strong></td> 
                          <td style="padding:0;Margin:0;"><h4 style="Margin:0;line-height:200%;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;color:#333333;">:نسبة التطبيق</h4></td> 
                         </tr>      
                             
                
                           <tr style="border-collapse:collapse;"> 
                            <td style="padding:0;Margin:0;color:#659C35;font-size: 20px;"><strong> SAR {{ $order->total - ($order->application_amount +  $order->tax_amount + $order->service_fees) }} </strong></td> 
                            <td style="padding:0;Margin:0;"><h4 style="Margin:0;line-height:200%;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;color:#333333;">:نسبة المالك</h4></td> 
                             </tr>
                           @endif
                       </table></td> 
                     </tr> 
