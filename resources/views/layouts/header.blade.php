                ...
                <div class="mobile-header__body">
                    <button class="mobile-header__menu-button">
                        <svg width="18px" height="14px">
                            <use xlink:href="/web/images/sprite.svg#menu-18x14"></use>
                        </svg>
                    </button>
                            ...
                            <form class="search__form" action="">
                                ...
                                <button class="search__button search__button--type--submit" type="submit">
                                    <svg width="20px" height="20px">
                                        <use xlink:href="/web/images/sprite.svg#search-20"></use>
                                    </svg>
                                </button>
                                <button class="search__button search__button--type--close" type="button">
                                    <svg width="20px" height="20px">
                                        <use xlink:href="/web/images/sprite.svg#cross-20"></use>
                                    </svg>
                                </button>
                    ...
                    <div class="mobile-header__indicators">
                        ...
                        <div class="indicator indicator--mobile d-sm-flex d-none">
                            <a href="wishlist.html" class="indicator__button">
                                        <span class="indicator__area">
                                            <svg width="20px" height="20px">
                                                <use xlink:href="/web/images/sprite.svg#heart-20"></use>
                                            </svg>
                        ...
                        <div class="indicator indicator--mobile">
                            <a href="cart.html" class="indicator__button">
                                        <span class="indicator__area">
                                            <svg width="20px" height="20px">
                                                <use xlink:href="/web/images/sprite.svg#cart-20"></use>
                                            </svg>
    ...
    <div class="site-header">
            ...
            <div class="topbar__container container">
                <div class="topbar__row">
                    <div class="topbar__item topbar__item--link">
                        <a class="topbar-link" href="/about">About Us</a>
                    </div>
                    {{--                    <div class="topbar__item topbar__item--link">--}}
                        ...
                        <div class="topbar-dropdown">
                            <button class="topbar-dropdown__btn" type="button">
                                ...
                                <svg width="7px" height="5px">
                                    <use xlink:href="/web/images/sprite.svg#arrow-rounded-down-7x5"></use>
                                </svg>
                            </button>
                                ...
                                <div class="menu menu--layout--topbar  menu--with-icons ">
                                    ...
                                    <ul class="menu__list">
                                        <li class="menu__item">
                                            ...
                                            <a class="menu__item-link" href="">
                                                <div class="menu__item-icon"><img
                                                            srcset="{{ assetWeb("images/languages/language-1.png") }}"
                                                            1x, {{ assetWeb('images/languages/language-1@2x.png') }} 2x"
                                                    src="{{ assetWeb('images/languages/language-1.png') }}" alt="">
                                                </div>
                                                English
                                            </a>
                                        </li>
                                        <li class="menu__item">
                                            ...
                                            <a class="menu__item-link" href="">
                                                <div class="menu__item-icon"><img
                                                            srcset="{{ assetWeb("images/languages/language-2.png") }}"
                                                            1x, {{ assetWeb('images/languages/language-2@2x.png') }} 2x"
                                                    src="{{ assetWeb('images/languages/language-2.png') }}" alt="">
                                                </div>
                                                French
                                            </a>
                                        </li>
                                        <li class="menu__item">
                                            ...
                                            <a class="menu__item-link" href="">
                                                <div class="menu__item-icon"><img
                                                            srcset="{{ assetWeb("images/languages/language-3.png") }}"
                                                            1x, {{ assetWeb('images/languages/language-3@2x.png') }} 2x"
                                                    src="{{ assetWeb('images/languages/language-3.png') }}" alt="">
                                                </div>
                                                German
                                            </a>
                                        </li>
                                        <li class="menu__item">
                                            ...
                                            <a class="menu__item-link" href="">
                                                <div class="menu__item-icon"><img
                                                            srcset="{{ assetWeb("images/languages/language-4.png") }}"
                                                            1x, {{ assetWeb('images/languages/language-4@2x.png') }} 2x"
                                                    src="{{ assetWeb('images/languages/language-4.png') }}" alt="">
                                                </div>
                                                Russian
                                            </a>
                                        </li>
                                        <li class="menu__item">
                                            ...
                                            <a class="menu__item-link" href="">
                                                <div class="menu__item-icon"><img
                                                            srcset="{{ assetWeb("images/languages/language-5.png") }}"
                                                            1x, {{ assetWeb('images/languages/language-5@2x.png') }} 2x"
                                                    src="{{ assetWeb('images/languages/language-5.png') }}" alt="">
                                                </div>
                                                Italian
                                            </a>
                                        </li>
        ...
        <div class="site-header__middle container">
            <div class="site-header__logo">
                <a href="index.html">
                    <!-- logo -->
                    <img src="{{ asset('assets/imgs/logo.png') }}" width="auto" height="80px"/>
                    <!-- logo / end -->
                </a>
            </div>
                            ...
                            <div class="departments  departments--open departments--fixed "
                                                ...
                                                <div class="departments__submenu departments__submenu--type--megamenu departments__submenu--size--xl">
                                                    ...
                                                    <div class="megamenu  megamenu--departments ">
                                                        <div class="megamenu__body"
                                                             style="background-image: url({{ assetWeb('images/megamenu/megamenu-1.jpg') }});">
                                                            <div class="row">
                                                                <div class="col-3">
                                ...
                                <button class="departments__button">
                                    ...
                                    <svg class="departments__button-arrow" width="9px" height="6px">
                                        <use xlink:href="/web/images/sprite.svg#arrow-rounded-down-9x6"></use>
                                    </svg>
                                </button>
                            </div>
                            <!-- .departments / end -->
                        ...
                        <div class="nav-panel__indicators">
                                            ...
                                            <div class="dropcart__products-list">
                                                <div class="dropcart__product">
                                                    <div class="product-image dropcart__product-image">
                                                        <a href="product.html" class="product-image__body">
                                                            <img class="product-image__img"
                                                                 src="{{ assetWeb('images/products/product-1.jpg') }}"
                                                                 alt="">
                                                        </a>
                                                    </div>
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        <svg width="10px" height="10px">
                                                            <use xlink:href="/web/images/sprite.svg#cross-10"></use>
                                                        </svg>
                                                    </button>
                                                </div>
                                                <div class="dropcart__product">
                                                    <div class="product-image dropcart__product-image">
                                                        <a href="product.html" class="product-image__body">
                                                            <img class="product-image__img"
                                                                 src="{{ assetWeb('images/products/product-2.jpg') }}"
                                                                 alt="">
                                                        </a>
                                                    </div>
                                                    <div class="dropcart__product-info">
                                                ...
                                                <div class="dropcart__product">
                                                    <div class="product-image dropcart__product-image">
                                                        <a href="product.html" class="product-image__body">
                                                            <img class="product-image__img"
                                                                 src="{{ assetWeb('images/products/product-5.jpg') }}"
                                                                 alt="">
                                                        </a>
                                                    </div>
                                                    <div class="dropcart__product-info">
                            ...
                            <div class="indicator indicator--trigger--click">
                                <a href="account-login.html" class="indicator__button">
                                            <span class="indicator__area">
                                                <svg width="20px" height="20px">
                                                    <use xlink:href="/web/images/sprite.svg#person-20"></use>
                                                </svg>
                                            </span>
                                </a>
                                <div class="indicator__dropdown">
                                    <div class="account-menu">
                                        ...
                                        <a href="account-dashboard.html" class="account-menu__user">
                                            <div class="account-menu__user-avatar">
                                                <img src="{{ assetWeb('images/avatars/avatar-3.jpg') }}" alt="">
                                            </div>
