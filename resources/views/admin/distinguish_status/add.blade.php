                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title" style="margin: 0;">Add Distinguish Status</h4>
                        </div>
                        <div class="card-content collpase show">
                            <div class="card-body">
                                ...
                                <form id="form"  method="post"  action="{{route("admin.distinguish.status.store")}}" enctype="multipart/form-data"  class="form form-horizontal needs-validation">
                                    @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-10">
                                             ...
                                             <div class="col-md-10">
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::textarea("ar_description", "" , ['class' => 'form-control' , 'id' =>  "ar_description", 'placeholder'=>"Ar Description ","required"=>"required"]) }}
                                            ...
                                            <div class="col-md-10">
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::textarea("en_description", "" , ['class' => 'form-control' , 'id' =>  "en_description", 'placeholder'=>"En Description "]) }}
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                             ...
                                             <div class="col-md-10">
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::text("price_for_once", '' , ['class' => 'form-control' , 'id' =>  "price_for_once"]) }}
                                             ...
                                             <div class="col-md-10">
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::text("price_for_twice", '' , ['class' => 'form-control' , 'id' =>  "price_for_twice"]) }}
                                             ...
                                             <div class="col-md-10">
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::text("price_for_three_times", '' , ['class' => 'form-control' , 'id' =>  "price_for_three_times"]) }}
