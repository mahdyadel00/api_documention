                    ...
                    <div class="card">
                        ...
                        <div class="card-content collpase show">
                            <div class="card-body">
                                ...
                                <form id="form"  method="post"  action="{{route("admin.page.store")}}" enctype="multipart/form-data"  class="form form-horizontal needs-validation">
                                    @csrf
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-10">
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::text("ar_title", '' , ['class' => 'form-control' , 'id' =>  "ar_title", 'placeholder'=>""]) }}
                                                    <div class="invalid-tooltip">
                                                        Name is Required
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <div class="form-group">
                                                    {{ Form::label("en_description", "Description (en) ",['class' => 'col-md-3']) }}
                                                       ...
                                                       {{ Form::textarea("en_description", "" , ['class' => 'ckeditor form-control' ]) }}
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    {{ Form::textarea("ar_description", "" , ['class' => 'ckeditor form-control' ]) }}
