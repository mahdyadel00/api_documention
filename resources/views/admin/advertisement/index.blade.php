                                                    ...
                                                    <td class="">
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu pull-left" role="menu">
                                                                <li>
                                                                    <a
                                                                        href="{{ route('admin.advertisement.edit', ['id' => $advertisement->id]) }}">
                                                                ...
                                                                <li>
                                                                    <a class="delete-item"
                                                                        ...
                                                                        data-action="{{ route('admin.advertisement.delete', ['id' => $advertisement->id]) }}"
