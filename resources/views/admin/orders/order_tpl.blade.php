                ...
                <main>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><b>From:</b> {{ \Carbon\Carbon::parse($product->from_date)->format(' M d, Y') }} -
                                    <b>To:</b> {{ \Carbon\Carbon::parse($product->to_date)->format(' M d, Y') }}</td>
                            </tr>
                            ...
                            <tr>
                                <td>
                                    <b>Days:&nbsp;{{ ($product->duration->days == 0) ? 1 : $product->duration->days }}</b>
                                </td>
                            </tr>
                            <tr>
                                <td>
                    ...
                    <div>
                        <h3 style="color:#900">Application Commission : {{ $order->application_amount }} SAR</h3>
                        <h3 style="color:#900">Tax : {{ $order->tax_amount }} SAR</h3>
                        <h2 style="color:#900">Sub Total : {{ $order->sub_total }} SAR</h2>
                        <h2 style="color:#900">Total Order : {{ $order->total }} SAR</h2>
