                                ...
                                <table class="table table-striped table-bordered table-hover table-checkable order-column" style="width: 100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $ticket->number }}</td>
                                            <td>{{ $ticket->report->ar_name }}</td>
                                            <td>{{ $ticket->comment }}</td>
                                            <td>
                                                <label class="switchToggle">
                                                    <input type="checkbox" data-id="{{ $ticket->id }}" class="is_blocked" {{ ($ticket->is_blocked == 1) ? "checked" : "" }}>
                                                    <span class="slider green round"></span>
                                                </label>
                                            </td>
                                            <td>
                                                <label class="switchToggle">
                                                    <input type="checkbox" data-id="{{ $ticket->id }}" class="is_finished" {{ ($ticket->is_finished == 1) ? "checked" : "" }}>
                                                    <span class="slider green round"></span>
                                                </label>
                                            </td>
