                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover table-checkable order-column" style="width: 100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{ $k+1 }}</td>
                                            <td>{{ $support->ar_title }}</td>
                                            <td>{{ $support->en_title }}</td>
                                            <td>{{ $support->ar_desc }}</td>
                                            <td>{{ $support->en_desc }}</td>
                                            ...
                                            <td class="">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu pull-left" role="menu">
                                                        <li>
                                                            <a href="{{ route('admin.support_help.edit',['id' => $support->id]) }}">
                                                                <i class="icon-pencil"></i> Edit
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a class="delete-item" data-id="{{ $support->id }}" data-action="{{ route('admin.support_help.store.delete',['id' => $support->id]) }}" href="javascript:void(0)">
