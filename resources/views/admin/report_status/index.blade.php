                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover table-checkable order-column" style="width: 100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{ $k+1 }}</td>
                                            <td>{{ $report->ar_name }}</td>
                                            <td>{{ $report->en_name }}</td>
                                            ...
                                            <td class="">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu pull-left" role="menu">
                                                        <li>
                                                            <a href="{{ route('admin.report_status.edit',['id' => $report->id]) }}">
                                                                <i class="icon-pencil"></i> Edit
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a class="delete-item" data-id="{{ $report->id }}" data-action="{{ route('admin.report_status.store.delete',['id' => $report->id]) }}" href="javascript:void(0)">
