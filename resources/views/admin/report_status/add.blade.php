                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title" style="margin: 0;">Add Reports</h4>
                        </div>
                        <div class="card-content collpase show">
                            <div class="card-body">
                                ...
                                <form id="form"  method="post"  action="{{route("admin.report_status.store")}}" enctype="multipart/form-data"  class="form form-horizontal needs-validation">
                                    @csrf
                                    ...
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('ar_name', '', ['class' => 'form-control', 'id' => 'ar_name', 'placeholder' => 'Entery your ar name', 'required']) }}
                                    ...
                                    <div class="col-md-10">
                                        <div class="form-group">
                                            ...
                                            {{ Form::text('en_name', '', ['class' => 'form-control', 'id' => 'en_name', 'placeholder' => 'Entery your en name', 'required']) }}
                                            <div class="invalid-tooltip">
                                                Name is Required
                                            </div>
                                        </div>
